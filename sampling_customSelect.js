...
function setLastCustomSelect() {
var x, i, j, l, ll, selElmnt, a, b, c;
/*look for any elements with the class "custom-select":*/
x = [document.getElementsByClassName("custom-select")[document.getElementsByClassName("custom-select").length-1]];
l = x.length;
for (i = 0; i < l; i++) {
  selElmnt = x[i].getElementsByTagName("select")[0];
  ll = selElmnt.length;
...
`
document.head.appendChild(style_select);
